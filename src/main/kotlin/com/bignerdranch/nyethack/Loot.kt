...
abstract class Hat : Loot(), Sellable, ItemClass
...
class Gemstones(
    override val value: Int,
    override val name: String = "Gemstones Gx$value"
) : Loot(), Sellable, ItemClass {
    operator fun plus(other: Gemstones) = Gemstones(value + other.value)
    operator fun minus(other: Gemstones) = Gemstones(value - other.value)
}
